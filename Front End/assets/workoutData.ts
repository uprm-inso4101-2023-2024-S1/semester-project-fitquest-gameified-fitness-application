...
export let Workouts = [
  ...
  ,
  {
    ...
    workout_name: "Arms",
    exercises: [
      { name: "Single Arm Row", duration: 10000, description: "", gif_link: "" },
      { name: "Overhead Shoulder Press", duration: 10000, description: "", gif_link: "" },
  ...
  },
  {
    ...
    exercises: [
      { name: "Squats", duration: 10000, description: "", gif_link: "" },
      { name: "Walking Lunges", duration: 10000, description: "", gif_link: "" },
